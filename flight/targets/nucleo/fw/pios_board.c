...
/* init sensor queue registration */
...
#if defined(PIOS_INCLUDE_HMC5883)
	{
		...
		if ((magnetometer == HWNUCLEO_MAGNETOMETER_EXTERNALI2CUART1) || (magnetometer == HWNUCLEO_MAGNETOMETER_EXTERNALI2CUART3))
		{
			...
			if ((adaptor_id != 0) && (PIOS_HMC5883_Init(adaptor_id, &pios_hmc5883_external_cfg) == 0)) {
				if (PIOS_HMC5883_Test() == 0) {
					...
					HwNucleoExtMagOrientationGet(&ext_mag_orientation);

					enum pios_hmc5883_orientation hmc5883_externalOrientation = \
						(ext_mag_orientation == HWNUCLEO_EXTMAGORIENTATION_TOP0DEGCW)      ? PIOS_HMC5883_TOP_0DEG      : \
						(ext_mag_orientation == HWNUCLEO_EXTMAGORIENTATION_TOP90DEGCW)     ? PIOS_HMC5883_TOP_90DEG     : \
						(ext_mag_orientation == HWNUCLEO_EXTMAGORIENTATION_TOP180DEGCW)    ? PIOS_HMC5883_TOP_180DEG    : \
						(ext_mag_orientation == HWNUCLEO_EXTMAGORIENTATION_TOP270DEGCW)    ? PIOS_HMC5883_TOP_270DEG    : \
						(ext_mag_orientation == HWNUCLEO_EXTMAGORIENTATION_BOTTOM0DEGCW)   ? PIOS_HMC5883_BOTTOM_0DEG   : \
						(ext_mag_orientation == HWNUCLEO_EXTMAGORIENTATION_BOTTOM90DEGCW)  ? PIOS_HMC5883_BOTTOM_90DEG  : \
						(ext_mag_orientation == HWNUCLEO_EXTMAGORIENTATION_BOTTOM180DEGCW) ? PIOS_HMC5883_BOTTOM_180DEG : \
						(ext_mag_orientation == HWNUCLEO_EXTMAGORIENTATION_BOTTOM270DEGCW) ? PIOS_HMC5883_BOTTOM_270DEG : \
